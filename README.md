...
This project is a simple e-shop web application created as a university semester subject KIV/WEB (Web applications) (2023/2024). The application is written in PHP using a custom object-oriented programming (OOP) architecture and custom routing through a main front controller.
